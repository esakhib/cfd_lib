...
request: str = "left"   #  right / left / both
...
q_left: float = 10000.0  # поток слева, W / m^2
q_right: float = 30000.0  # поток справа, W / m^2
...
time_steps: int = 10  # количесвто врем промежутков        рассчитать по заданному dt
